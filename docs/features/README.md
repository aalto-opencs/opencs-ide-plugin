...
Describes browser PKCE sign-in, secure session handling, account actions, and
sign-out behavior.

## Initial Setup and Assignment Folder

[Initial Setup and Assignment Folder](./initial-setup.md)

Describes setup-state transitions, per-student assignment-root selection, and
the preservation boundary for external student files.

## Platform Assignment Deep Links

[Platform Assignment Deep Links](./assignment-deep-links.md)

Describes identifier validation, resumable sign-in, enrolment confirmation,
course-instance resolution, and safe exercise selection.
...
Describes assignment-folder layout, safe starter extraction, download identity,
workspace opening, and explicit replacement of student work.

## Assignment Handout View

[Assignment Handout View](./assignment-handout.md)

Describes first-use placement, local Markdown rendering, live refresh, state
messages, and Webview content safety.

## Assignment Content-Version Verification

[Assignment Content-Version Verification](./assignment-content-version.md)

Describes download-time revision stability and advisory pre-submission checks.

## Submission File Selection

[Submission File Selection](./submission-file-selection.md)

Describes manifest-based and fallback file collection, validation, payload
limits, and exact-file confirmation.

## Submission and Grading

[Submission and Grading](./submission-and-grading.md)

Describes submission validation, confirmation, upload, grading polling, and
...
Describes backend history synchronization, offline caching, current-exercise
filtering, and failed-test or grader-error inspection.

## Platform Status Check

[Platform Status Check](./platform-status.md)

Describes the public unauthenticated availability check and its intentionally
limited meaning.
...
Describes how local run and confirmed-submit snapshots are retained and sent
with an assignment submission.
