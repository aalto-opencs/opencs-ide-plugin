...
This review covers setup, Course Selection, Course Parts, Exercise, and
Submissions views; the Account Quick Pick; commands;
...
- The Account toolbar action uses a native Quick Pick with explicit Change
  Assignment Folder and Sign Out actions.
...
open Aalto Fitech Platform, move among the four working views, traverse rows with arrow
